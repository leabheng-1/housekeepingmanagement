...
class yearlyReport extends StatefulWidget {
  @override
  _yearlyReportState createState() => _yearlyReportState();
}
String start_date = ''; 
String end_date = '';
...
class _yearlyReportState extends State<yearlyReport> {
  ...
  Future<void> fetchData() async {
    ...
    final response = await http.get(Uri.parse('http://127.0.0.1:8000/api/report/yearly?room_type=$room_type&room_number=$room_number_filter'));
    Url='http://127.0.0.1:8000/api/report/yearly?start_date=$start_date&end_date=$end_date&room_type=$room_type&room_number=$room_number_filter';
